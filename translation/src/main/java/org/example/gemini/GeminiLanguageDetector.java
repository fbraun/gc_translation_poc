...
public class GeminiLanguageDetector {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String context = "Context is sports betting. Only return the language.";

        String detectedLanguage = translate(originalText, context, apiKey);
        System.out.println("Original Text: " + originalText);
        System.out.println("Detected Language: " + detectedLanguage);
    }

    public static String translate(String text, String context, String apiKey) throws Exception {
        ...
        String jsonInputString = String.format("{\"contents\":[{\"parts\":[{\"text\":\"What language is the following text in: '%s'. The context is: %s\"}]}]}",
                 text, context);
